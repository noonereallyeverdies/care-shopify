  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="relative z-20 bg-linear-to-b from-neutral-800 to-neutral-600 bg-clip-text text-center font-sans text-5xl font-medium tracking-tight text-transparent md:text-6xl lg:text-7xl"
      >
        The Science of Glow
      </motion.h1>
      <motion.p
      ...
      >
        <div className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-neutral-200/60 bg-white/90 p-8 shadow-lg transition-all duration-300 ease-in-out hover:border-red-200/60 hover:shadow-xl">
          ...
          <div className="absolute -bottom-16 -right-16 h-32 w-32 rounded-full bg-linear-to-tl from-red-50 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-70" />
        </div>
