...
Call log:
  - navigating to "http://localhost:4002/", waiting until "load"
    ...
    at /Users/yvonne/Desktop/care/new-hydrogen-app/tests/qa-technical-landing-page.spec.ts:42:33
```
...
- main:
  ...
  - text: "$89 $129 save 31% device + precision oils + USB-C charger + travel case + 60-day guarantee 347 of 500 remaining • offer ends in: 23 : 42 : 01"
