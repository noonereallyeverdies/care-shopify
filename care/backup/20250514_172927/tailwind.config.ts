...
// import path from 'path'; // Removing path import as it's not used with simpler relative path

export default {
  content: [
    'care-shopify/care/app/**/*.{js,ts,jsx,tsx}' // Path relative to potential workspace root CWD
  ],
  theme: {
    extend: {
      fontSize: {
