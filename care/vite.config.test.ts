...
export default defineConfig({
  plugins: [
    hydrogen(),
    // Temporarily disable oxygen plugin to see if that's the issue
    // oxygen(),
    remix({
      ...
      // Explicitly ignore backup and optimized files
  ...
  // Explicitly exclude backup files from being processed
  assetsInclude: ['**/*'],
  server: {
    watch: {
